...
<% if ("Customer".equals(userRole)) { %>
    <div class="nav">
        <a href="CustomerProductsPageController">Products</a>
        <a href="CustomerOrdersController">Orders</a> 
        <a href="CustomerEditController">Personal Profile</a>
    </div>
<% } %>

<%-- Manager Navigation --%>
<% if ("Managing Staff".equals(userRole)) { %>
    <div class="nav">
